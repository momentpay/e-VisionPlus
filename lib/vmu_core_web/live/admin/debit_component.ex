defmodule VmuCoreWeb.Live.Admin.DebitComponent do
  ...
  defp account_list_row(a) do
    %{
      row_id: to_string(a.debit_account_id),
  ...
  def render(%{mode: :list} = assigns) do
    ...
    <div id={@id} class="component-panel">
      ...
      <.ag_grid
        ...
        empty_message="No debit accounts found."
        columns={[
          %{field: "customer_name", header: "Customer", flex: 1},
          %{field: "balance", header: "Available Balance", type: "money", width: 170},
